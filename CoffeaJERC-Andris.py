...
def main():
    ...
    def main():
        ...
        test_run          = False   ### True to run only on one file and five chuncs to debug processor
        ...
        add_tag = '_QCD_MG_Py8-2000toInf' #-etaAut18'
        ...
        if combineTTbar:
            ...
            filesets = {"HT2000toInf": filesets["HT2000toInf"]} #["2000toInf"] = {"files": fileslist, "metadata": {"xsec": xsec_dict[key]}}
            print(f"Running on filesets = {filesets}")
